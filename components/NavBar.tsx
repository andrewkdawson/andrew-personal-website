...
export function NavBar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white dark:bg-duke-navy-800 border-b border-gray-200 dark:border-duke-navy-700 backdrop-blur-sm bg-opacity-90">
          ...
          <div className="md:hidden pb-4 space-y-2">
            {navLinks.map((link) => (
              <Link
                ...
                className={`block px-3 py-2 text-base font-medium rounded-md transition-colors ${isActive(link.href)
